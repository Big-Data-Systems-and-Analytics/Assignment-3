...
parser.add_argument('--sevir_data', type=str, help='location of SEVIR dataset',default='/content/neurips-2020-sevir/data/sevir')
parser.add_argument('--sevir_catalog', type=str, help='location of SEVIR dataset',default='/content/neurips-2020-sevir/data/CATALOG.csv')
parser.add_argument('--output_location', type=str, help='location of SEVIR dataset',default='/content/neurips-2020-sevir/data/interim')
